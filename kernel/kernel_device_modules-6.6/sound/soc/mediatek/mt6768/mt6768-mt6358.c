...
/* A14_V code for AL6528AV-5 by zhouchenghua at 20240815 start */
#include <linux/of_gpio.h>
#include <linux/gpio.h>
#include <linux/spinlock.h>
/* A06_V code for AL7160AV-5 by zhouchenghua at 20240819 start */
// Add support for FS1512GN
#ifdef FSM_FS1512GN_SUPPORT
#define FS15XX_START  (220)        // 200us < Tsta < 1000us */
#define FS15XX_PULSE_DELAY_US (10) // 2us < t < 150us
#define FS15XX_T_WORK  (820)       // Twork > 800us
#define FS15XX_T_PWD  (5000)       // Tswton suggest to be 3ms+ between each mode
#define FS15XX_RETRY  (10)
#define FS15XX_OFF_MODE 0
#define FS15XX_OPEN_MODE 6
#define FS15XX_MAX_MODE 12
#else // support for FS1512N
...
#endif
/* A06_V code for AL7160AV-5 by zhouchenghua at 20240819 end */
...
/* A14_V code for AL6528AV-5 by zhouchenghua at 20240815 end */
...
int fs15xx_set_mode(int fsm_mode_new, int aw_mode_new)
{
    ...
    if (fsm_mode_new > FS15XX_MAX_MODE || fsm_mode_new < 0 || aw_mode_new > 10 || aw_mode_new < 0) {
        // invalid mode
        return -1;
    }
...
/* A06_V code for AL7160AV-5 by zhouchenghua at 20240819 start */
#ifdef FSM_FS1512GN_SUPPORT
    count = (g_fsm_mode < 3) ? g_fsm_mode - 1 : g_fsm_mode + 1;
#else
    count = g_fsm_mode - 1;
#endif
/* A06_V code for AL7160AV-5 by zhouchenghua at 20240819 end */
...
/* A06_V code for AL7160AV-5 by zhouchenghua at 20240819 start */
#ifdef FSM_FS1512GN_SUPPORT
        fs15xx_set_mode(FS15XX_OPEN_MODE, AW87XX_OFF_MODE);
#else
