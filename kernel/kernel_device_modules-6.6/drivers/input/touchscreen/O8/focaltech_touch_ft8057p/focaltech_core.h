...
// extern int usb_check_notifier_call_chain(unsigned long val,void *v);
...
// extern bool get_tp_enable(void);
// extern const char* tp_choose_panel(void);
// extern void tp_common_init(struct lcm_info *g_lcm_info);
// extern int tp_detect_panel(const char *tp_ic);
/*++++++++++touch+++++++++*/
/*a06 code for AL7160A-5 by wenghailong at 20240321 start*/
#define FTS_NAME_LEN 64
/*a06 code for AL7160A-5 by wenghailong at 20240321 end*/
/*****************************************************************************
...
struct fts_ts_data {
    ...
    struct workqueue_struct * tp_usb_notify_wq;
    struct work_struct tp_usb_notify_work;
    struct notifier_block tp_earphone_notify;
    struct workqueue_struct *tp_earphone_notify_wq;
    struct work_struct tp_earphone_notify_work;
