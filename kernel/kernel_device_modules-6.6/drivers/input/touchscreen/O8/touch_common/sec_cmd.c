...
/*A06 code for SR-AL7160V-01-78 by hehaoran at 20240827 start*/
struct device *sec_key = NULL;
static unsigned int g_key_power_state = 0;
static unsigned int g_key_volumedown_state = 0;
static unsigned int g_key_volumeup_state = 0;
/*A06 code for SR-AL7160V-01-78 by hehaoran at 20240827 end*/
...
/*A06 code for SR-AL7160V-01-78 by hehaoran at 20240827 start*/
void get_keypad_key_state(unsigned int keycode,int pressed)
{
	if (keycode == KEY_VOLUMEUP) {
		g_key_volumeup_state = pressed;
	}
}
EXPORT_SYMBOL(get_keypad_key_state);

void get_pmic_key_state(unsigned int keycode,int pressed)
{
...
EXPORT_SYMBOL(get_pmic_key_state);
/*A06 code for SR-AL7160V-01-78 by hehaoran at 20240827 end*/
