...
static const struct proc_ops hx_info_proc_fops = {
    .proc_read = hx_proc_getinfo_read,
};
...
int himax_report_data(struct himax_ts_data *ts, int ts_path, int ts_status)
{
    ...
    if (ts_path == HX_REPORT_COORD || ts_path == HX_REPORT_COORD_RAWDATA) {
        ...
        /*A14 code for SR-AL6528V-01-144 by renbulang at 20240913 start*/
        if (ts->hx_point_num != 0) {
            if (get_tp_enable()) {
        ...
        /*A14 code for SR-AL6528V-01-144 by renbulang at 20240913 end*/
...
static void himax_update_module_info(void)
{
    ...
    if (tp_choose_panel("lcd_hx83112f_txd_boe_mipi_fhd_video")) {
        strcpy(ts->module_name,"lcd_hx83112f_txd_boe_mipi_fhd_video");
        strcpy(ts->himax_nomalfw_rq_name, "hx83112f_txd_boe_firmware.bin");
        strcpy(ts->himax_mpfw_rq_name, "hx83112f_txd_boe_mpfw.bin");
        strcpy(ts->himax_csv_name, "hx83112f_txd_boe_mp_test.csv");
    } else {
...
/*A14 code for SR-AL6528V-01-144 by lihao at 20240918 start*/
...
/*A14 code for SR-AL6528V-01-144 by lihao at 20240918 end*/
...
#if defined(HX_CONFIG_FB) || defined(HX_CONFIG_DRM) || defined(HX_CONFIG_DRM_MTK)
