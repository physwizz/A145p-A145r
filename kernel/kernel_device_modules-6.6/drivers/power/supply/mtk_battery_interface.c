...
/* power misc end*/
/* ============================================================ */
/*A06_V code for SR-AL7160V-01-168 by xiongxiaoliang at 20240913 start*/
#define SS_BAT_COLD_TEMP	0
#define SS_BAT_HOT_TEMP		50
/*A06_V code for SR-AL7160V-01-168 by xiongxiaoliang at 20240913 end*/
void battery_update(struct mtk_battery_manager *bm)
{
	...
	if (bat_data->bat_capacity == 100 &&
		...
		pr_err("battery_update set FULL!  status:%d\n",
	...
	/*A06_V code for SR-AL7160V-01-168 by xiongxiaoliang at 20240913 end*/
	pr_err("battery_update status:%d\n",bat_data->bat_capacity);
	/*A06_V code for  SR-AL7160V-01-172  by yexuedong at 20240903 end*/
