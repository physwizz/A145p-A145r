 ...
 *
 *********************************************************/
/*A06_V code for SR-AL7160V-01-163/AL6528A-12 by shanxinkai at 20240926 start*/
#define SGM415XX_REG_NUM    (0xD)
/*A06_V code for SR-AL7160V-01-163/AL6528A-12 by shanxinkai at 20240926 end*/
...
static void sgm415xx_force_detection_dwork_handler(struct work_struct *work)
{
    ...
    if (sgm->vbus_gd && (sgm->typec_attached == ATTACH_TYPE_TYPEC)) {
        ...
        /*A06_V code for AL7160AV-49 by xiongxiaoliang at 20241114 start*/
        sgm->force_dpdm_done = true;
        /*A06_V code for AL7160AV-49 by xiongxiaoliang at 20241114 end*/
...
static int sgm415xx_get_chrg_stat(struct sgm415xx_device *sgm)
{
    ...
    /*A06_V code for AL7160AV-48 by xiongxiaoliang at 20241113 start*/
    pr_err("[%s] chrg_value=%d, chrg_stat=%d, chrg_type=%d\n", __func__, chrg_value, chrg_stat, sgm->state.chrg_type);
    /*A06_V code for AL7160AV-48 by xiongxiaoliang at 20241113 end*/
    return chrg_value;
}
 ...
 *
 *********************************************************/
/*A06_V code for AL6528A-12 by shanxinkai at 20240926 start*/
...
/*A06_V code for AL6528A-12 by shanxinkai at 20240926 end*/
...
static irqreturn_t sgm415xx_irq_handler_thread(int irq, void *private)
{
    ...
    /*A06_V code for AL7160AV-48|AL7160AV-49 by xiongxiaoliang at 20241114 start*/
    ...
    /*A06_V code for AL7160AV-48|AL7160AV-49 by xiongxiaoliang at 20241114 end*/
    /*A06_V code for SR-AL7160V-01-138 by xiongxiaoliang at 20240910 start*/
