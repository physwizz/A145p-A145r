...
int battery_get_profile_id(void)
{
    ...
    if (id_volt >= BATTERY_SDI_ID_VOLT_LOW && id_volt <= BATTERY_SDI_ID_VOLT_HIGH) {
        id = GXY_BATTERY_TYPE_SDI;
    } else if (id_volt >= BATTERY_BYD_ID_VOLT_LOW && id_volt <= BATTERY_BYD_ID_VOLT_HIGH) {
        id = GXY_BATTERY_TYPE_BYD;
    } else if (id_volt >= BATTERY_ATL_ID_VOLT_LOW && id_volt <= BATTERY_ATL_ID_VOLT_HIGH) {
        id = GXY_BATTERY_TYPE_ATL;
    } else if (id_volt >= BATTERY_GF_ID_VOLT_LOW && id_volt <= BATTERY_GF_ID_VOLT_HIGH) {
        id = GXY_BATTERY_TYPE_GF;
    } else {
