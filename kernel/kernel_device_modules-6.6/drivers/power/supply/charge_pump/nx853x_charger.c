...
struct nx853x_chip *g_nx853x = NULL;
...
/******************External interface************/
int nx853x_usbpd_get_present(int *value)
{
    if (g_nx853x != NULL) {
        *value = g_nx853x->usb_present;
        return true;
    } else {
        return false;
    }
...
int nx853x_usbpd_set_present(int *value)
{
    if (g_nx853x != NULL) {
        nx853x_set_present(g_nx853x, !!(*value));
        return true;
    } else {
        return false;
    }
...
int nx853x_usbpd_get_charging_enabled(bool *value)
{
    int ret = 0;
    int result = 0;

    if (g_nx853x != NULL) {
        ret = nx853x_check_charge_enabled(g_nx853x, &result);
        if (!ret) {
            g_nx853x->charge_enabled = !!result;
        }

        *value = g_nx853x->charge_enabled;
        return true;
    } else {
        return false;
    }
...
int nx853x_usbpd_set_charging_enabled(bool *value)
{
    if (g_nx853x != NULL) {
        nx853x_enable_charge(g_nx853x, !!(*value));
        return true;
    } else {
        return false;
    }
...
int nx853x_usbpd_get_vbus(int *value)
{
    int ret = 0;
    int result = 0;

    if (g_nx853x != NULL) {
        ret = nx853x_get_adc_data(g_nx853x, ADC_VBUS, &result);
        if (!ret) {
            g_nx853x->vbus_volt = result;
        }

        *value = g_nx853x->vbus_volt;
        return true;
    } else {
        return false;
    }
...
int nx853x_usbpd_get_ibus(int *value)
{
    int ret = 0;
    int result = 0;

    if (g_nx853x != NULL) {
        ret = nx853x_get_adc_data(g_nx853x, ADC_IBUS, &result);
        if (!ret) {
            g_nx853x->ibus_curr = result;
        }

        *value = g_nx853x->ibus_curr;
        return true;
    } else {
        return false;
    }
...
int nx853x_usbpd_get_vbat(int *value)
{
    int ret = 0;
    int result = 0;

    if (g_nx853x != NULL) {
        ret = nx853x_get_adc_data(g_nx853x, ADC_VBAT, &result);
        if (!ret) {
            g_nx853x->vbat_volt = result;
        }

        *value = g_nx853x->vbat_volt;
        return true;
    } else {
        return false;
    }
...
int nx853x_usbpd_get_ibat(int *value)
{
    int ret = 0;
    int result = 0;

    if (g_nx853x != NULL) {
        ret = nx853x_get_adc_data(g_nx853x, ADC_IBAT, &result);
        if (!ret) {
            g_nx853x->ibat_curr = result;
        }

        *value = g_nx853x->ibat_curr;
        return true;
    } else {
        return false;
    }
...
int nx853x_usbpd_get_temp(int *value)
{
    int ret = 0;
    int result = 0;

    if (g_nx853x != NULL) {
        ret = nx853x_get_adc_data(g_nx853x, ADC_TDIE, &result);
        if (!ret) {
            g_nx853x->die_temp = result;
        }

        *value = g_nx853x->die_temp;
        return true;
    } else {
        return false;
    }
...
/*A06_V code for SR-AL7160V-01-92 by xiongxiaoliang at 20240904 start*/
int nx853x_usbpd_set_otg_txmode(int *value)
{
    int enable = *value;

    if (g_nx853x != NULL) {
        nx853x_charger_enable_otg(g_nx853x, enable);
        return true;
    } else {
        return false;
    }
...
int nx853x_usbpd_get_otg_txmode(int *value)
{
    if (g_nx853x != NULL) {
        *value = g_nx853x->otg_tx_mode;
        return true;
    } else {
        return false;
    }
...
static int nx853x_charger_probe(struct i2c_client *client)
{
    ...
    /*A06 code for AL7160A-82 by jiashixian at 20240418 end*/
    g_nx853x = sc;
    g_gxy_cp_ops.get_present = nx853x_usbpd_get_present;
    g_gxy_cp_ops.set_present = nx853x_usbpd_set_present;
    g_gxy_cp_ops.set_charging_enabled = nx853x_usbpd_set_charging_enabled;
    g_gxy_cp_ops.get_charging_enabled = nx853x_usbpd_get_charging_enabled;
    g_gxy_cp_ops.get_vbus = nx853x_usbpd_get_vbus;
    g_gxy_cp_ops.get_ibus = nx853x_usbpd_get_ibus;
    g_gxy_cp_ops.get_vbat = nx853x_usbpd_get_vbat;
    g_gxy_cp_ops.get_ibat = nx853x_usbpd_get_ibat;
    g_gxy_cp_ops.get_temp = nx853x_usbpd_get_temp;
    /*A06_V code for SR-AL7160V-01-92 by xiongxiaoliang at 20240904 start*/
    g_gxy_cp_ops.set_otg_txmode = nx853x_usbpd_set_otg_txmode;
...
static void nx853x_charger_remove(struct i2c_client *client)
{
