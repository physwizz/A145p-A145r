	...
	struct mtk_gauge_sysfs_field_info *attr, int *zcv)
{
	signed int adc_result_reg = 0;
	signed int adc_result = 0;
	/*A06_V code for SR-AL7160V-01-17 by yexuedong at 20240912 start*/
	static int old_zcv = 0;
	/*A06_V code for SR-AL7160V-01-17 by yexuedong at 20240912 end*/
	...
	/*A06_V code for SR-AL7160V-01-17 by yexuedong at 20240912 start*/
	bm_err(gauge_dev->gm, "[oam] %s BATSNS  (pchr):adc_result_reg=%d, adc_result=%d, old_zcv = %d\n",
