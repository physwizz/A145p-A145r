...
/*****************************O8 camera sensor define start ***************************************/
	...
	//add for A0601
	UINT32 A0601LYBACKS5KJN1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
	UINT32 A0601DDFRONTSC820CS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
	UINT32 A0601CXTDEPTHGC02M1B_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
	//add for A0602
	UINT32 A0602XLBACKS5KJN1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
	UINT32 A0602CXTFRONTGC08A8_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
	UINT32 A0602WXDEPTHC2519_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
	//add for A0603
	UINT32 A0603TXDBACKS5KJN1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
	...
	//add for A0604
	UINT32 A0604XLBACKS5KJN1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
	...
	//add for A0605
	UINT32 A0605OFBACKS5KJN1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
