...
static const struct proc_ops hqextend_cameraSNInfo_fops = {
    .proc_read = hqextend_cameraSNInfo_read,
    .proc_write = hqextend_cameraSNInfo_write,
};
#endif
