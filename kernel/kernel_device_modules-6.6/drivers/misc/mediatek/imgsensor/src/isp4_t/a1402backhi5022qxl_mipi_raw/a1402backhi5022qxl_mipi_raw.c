...
#include "a1402backhi5022qxl_mipi_raw.h"

#define PFX "a1402backhi5022qxl_mipi_raw"
...
static struct imgsensor_info_struct imgsensor_info = {
     .sensor_id = A1402BACKHI5022QXL_SENSOR_ID,
     ...
     .custom1 = {
         ...
         /*     following for GetDefaultFramerateByScenario()    */
         .max_framerate = 240,
         .mipi_pixel_rate =432000000,//1080Mbps*4/10
     },
     .custom2 = {
         .pclk = 124000000,
         .linelength =  1368,
...
#define HI5022Q_EEPROM_SLAVE_ADDR 0xB0
...
static void HI5022Q_read_data_from_eeprom(kal_uint8 slave, kal_uint32 start_add, uint32_t size)
{
    ...
    {////if its way1,need continue read
        for ( ; i < HI5022Q_EEPROM_SIZE_WAY1; i ++)
        {
            HI5022Q_eeprom[i] = read_cmos_sensor_8(start_add);
            start_add ++;
        }
...
UINT32 A1402BACKHI5022QXL_MIPI_RAW_SensorInit(struct
