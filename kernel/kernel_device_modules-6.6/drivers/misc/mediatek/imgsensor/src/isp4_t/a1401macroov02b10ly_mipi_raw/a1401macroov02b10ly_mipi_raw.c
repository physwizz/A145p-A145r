...
/*hs14 code for SR-AL6528A-01-51 by caoshiyong at 2022-9-29 start*/
/*hs14 code for AL6528ADEU-1828 by jianghongyan at 2022-11-3 start*/
...
#include "a1401macroov02b10ly_mipi_raw.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = A1401MACROOV02B10LY_SENSOR_ID,
	.checksum_value = 0x3cde62ee,       //0x6d01485c // Auto Test Mode 蓄板..
	.pre = {
		.pclk = 18000000,            //record different mode's pclk
		.linelength = 425,            //record different mode's linelength
        .framelength = 1412,            //record different mode's framelength
	...
	.normal_video = {
		.pclk = 18000000,            //record different mode's pclk
		.linelength = 425,            //record different mode's linelength
        .framelength = 1764,            //record different mode's framelength
		.startx = 0,                    //record different mode's startx of grabwindow
		.starty = 0,                    //record different mode's starty of grabwindow
		.grabwindow_width = 1600,        //record different mode's width of grabwindow
		.grabwindow_height = 1200,        //record different mode's height of grabwindow
	...
	.hs_video = {
		.pclk = 18000000,            //record different mode's pclk
		.linelength = 425,            //record different mode's linelength
        .framelength = 1411,            //record different mode's framelength
		.startx = 0,                    //record different mode's startx of grabwindow
		.starty = 0,                    //record different mode's starty of grabwindow
		.grabwindow_width = 1600,        //record different mode's width of grabwindow
		.grabwindow_height = 900,        //record different mode's height of grabwindow
		/*     following for MIPIDataLowPwr2HighSpeedSettleDelayCount by different scenario    */
		.mipi_data_lp2hs_settle_dc = 85,//unit , ns
		.mipi_pixel_rate = 72000000,
		/*     following for GetDefaultFramerateByScenario()    */
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5]={
	{  1600, 1200,  0, 0, 1600, 1200, 1600, 1200,
	   0000, 0000, 1600, 1200,  0, 0, 1600, 1200}, // Preview
	{  1600, 1200,  0, 0, 1600, 1200, 1600, 1200,
	   0000, 0000, 1600, 1200,  0, 0, 1600, 1200}, // capture
	{  1600, 1200,  0, 0, 1600, 1200, 1600, 1200,
	   0000, 0000, 1600, 1200,  0, 0, 1600, 1200}, // video
	{  1600, 1200,  0, 150, 1600, 900, 1600, 900,
	   0000, 0000, 1600, 900,  0, 0, 1600, 900}, //hight speed video
	{  1600, 1200,  0, 150, 1600, 900, 1600, 900,
	   0000, 0000, 1600, 900,  0, 0, 1600, 900},// slim video
};
...
#if OV02B10_EEPROM_ENABLE
static kal_uint16 read_eeprom_module(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };
    pr_err("OV02B10_EEPROM_I2C_ADDR = 0x%x \n",OV02B10_EEPROM_I2C_ADDR);
...
/*hs14 code for SR-AL6528A-01-67 by rongyi at 2022-9-6 start*/
	return ((read_cmos_sensor(0x02) << 8) | read_cmos_sensor(0x03));
/*hs14 code for SR-AL6528A-01-67 by rongyi at 2022-9-6 end*/
}
...
static int get_eeprom_data(EEPROM_DATA *data)
{
    ...
    otp_data = (u8 *)data;
    for (i=0;i<=0x0E;i++)
        pr_err("ov02b10 [simon]otpdata[0x%x]=0x%x \n", i, *(otp_data + i));
#endif
    return 0;
}
#endif
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			hw_info_main3_otp.vendor_id = pOtp_data.supplier_code;
			hw_info_main3_otp.module_code = pOtp_data.module_code;
			hw_info_main3_otp.module_ver = pOtp_data.module_version;
...
/*hs14 code for AL6528ADEU-1828 by jianghongyan at 2022-11-3 end*/
/*hs14 code for SR-AL6528A-01-51 by caoshiyong at 2022-9-29 end*/