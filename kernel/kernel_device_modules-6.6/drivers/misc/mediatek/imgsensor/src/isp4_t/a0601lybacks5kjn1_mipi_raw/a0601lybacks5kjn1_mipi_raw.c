...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[9] = {
	...
	//custom1
	{ 8160, 6144, 816, 1236, 6528, 3672, 3264, 1836, 0, 0, 3264, 1836, 0, 0, 3264, 1836 },
	//custom2
	{ 8160, 6144, 0, 0, 8160, 6144, 4080, 3072, 0, 0, 4080, 3072, 0, 0,  4080, 3072 },
	//custom3
	{ 8160, 6144, 240, 912, 7680, 4320, 3840, 2160, 0, 0, 3840, 2160, 0, 0, 3840, 2160 },
	//custom4
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_s5kjn1acc2[] = {
	0x6226, 0x0001,
	0x6028, 0x2400,
	0x602A, 0x801C,
	0x6F12, 0x1743,
...
// A06 code for SR-AL7160A -01-502by xuyunhui at 20240909 end
/*********************************************************************************************/
#if EEPROM_READY //stan

static int  eeprom_enable = 0;
/* A06 code for SR-AL7160A-01-502 by zhongquan at 20240426 start */
__attribute__((unused)) static void write_cmos_sensor_8bit(kal_uint32 addr, kal_uint32 para)
{
	char pu_send_cmd[2] = {(char)(addr & 0xff), (char)(para & 0xff)};

	iWriteRegI2C(pu_send_cmd, 2, imgsensor.i2c_write_id);
}
__attribute__((unused)) static kal_uint16 read_cmos_sensor_8bit(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
...
#define S5KJN1_EEPROM_SIZE  0x318D
...
/* A06 code for SR-AL7160A-01-502 by zhongquan at 20240426 start */
/* A06 code for AL7160A-3977 by zhongquan at 20240719 start */
static void S5KJN1_read_eeprom_unlock(kal_uint8 slave)
{
	...
	write_cmos_sensor_8bit(0x07,0x34);
...
/* A06 code for AL7160A-3977 by zhongquan at 20240719 end */
/* A06 code for SR-AL7160A-01-502 by zhongquan at 20240426 end */
...
/* A06 code for SR-AL7160A-01-537 by dingling at 20240420 start */
#define XTC_OFFSET 0xD5A
#define SENSOR_XTC_OFFSET 0x1B0A
#define PDXTC_OFFSET 0x1E0C
#define SWGGC_OFFSET 0x2DAE

/* A06 code for SR-AL7160A-01-537 by dingling at 20240420 end */
...
/* A06 code for SR-AL7160A-917 by zhongquan at 20240529 start */
#define SENSOR_SN_OFFSET 0x317E
...
static void sensor_init(void)
{
	...
	mdelay(5);
	s5kjn1_multi_write_cmos_sensor(addr_data_pair_init_s5kjn1acc2,
				       sizeof(addr_data_pair_init_s5kjn1acc2) /
					       sizeof(kal_uint16));
#if EEPROM_READY //stan
if(eeprom_enable == 1)
{
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_s5kjn1acc2[] = { //4080*3072 30fps
	0xFCFC, 0x2400,
	0x0710, 0x0002,
	0x0712, 0x0804,
	0x0714, 0x0100,
...
static void preview_setting(void)
{
	...
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_preview_s5kjn1acc2,
		sizeof(addr_data_pair_preview_s5kjn1acc2) / sizeof(kal_uint16));
}
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_s5kjn1acc2[] = { //2000*1132 120fps
    0xFCFC, 0x2400,
	0x0710, 0x0004,
	0x0712, 0x0401,
	0x0714, 0x0100,
...
static void hs_video_setting(void) /// 120fps
{
	...
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_hs_video_s5kjn1acc2,
		sizeof(addr_data_pair_hs_video_s5kjn1acc2) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_s5kjn1acc2[] = { //4080*3072 30fps
	0xFCFC, 0x2400,
	0x0710, 0x0002,
	0x0712, 0x0804,
	0x0714, 0x0100,
...
static void capture_setting(kal_uint16 currefps)
{
	LOG_INF("start\n");
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_capture_s5kjn1acc2,
		sizeof(addr_data_pair_capture_s5kjn1acc2) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_normal_video_s5kjn1acc2[] = { //4080*3072 30fps
	0xFCFC, 0x2400,
	0x0710, 0x0002,
	0x0712, 0x0804,
	0x0714, 0x0100,
...
static void normal_video_setting(kal_uint16 currefps) // 30fps
{
	...
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_normal_video_s5kjn1acc2,
		sizeof(addr_data_pair_normal_video_s5kjn1acc2) /
			sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_s5kjn1acc2[] = { //1920*1080 30fps
    0xFCFC, 0x2400,
	0x0710, 0x0004,
	0x0712, 0x0401,
	0x0714, 0x0100,
...
static void slim_video_setting(void) //60fps
{
	...
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_slim_video_s5kjn1acc2,
		sizeof(addr_data_pair_slim_video_s5kjn1acc2) /
			sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_s5kjn1acc2[] = { //3264*1836 24fps
...
static void custom1_setting(void)
{
	LOG_INF("E\n");
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_custom1_s5kjn1acc2,
		sizeof(addr_data_pair_custom1_s5kjn1acc2) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custom2_s5kjn1acc2[] = { //4080*3072 24fps
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static void custom2_setting(void)
{
	LOG_INF("E\n");
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_custom2_s5kjn1acc2,
		sizeof(addr_data_pair_custom2_s5kjn1acc2) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custom3_s5kjn1acc2[] = { //3840*2160 60fps
	0xFCFC, 0x2400,
	0x0710, 0x0002,
	0x0712, 0x0804,
	0x0714, 0x0100,
...
static void custom3_setting(void)
{
	LOG_INF("E\n");
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_custom3_s5kjn1acc2,
		sizeof(addr_data_pair_custom3_s5kjn1acc2) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custom4_s5kjn1acc2[] = { //8160*6144 10fps
	0xFCFC, 0x2400,
	0x0710, 0x0010,
	0x0712, 0x0201,
	0x0714, 0x0800,
...
static void custom4_setting(void)
{
	LOG_INF("E\n");
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_custom4_s5kjn1acc2,
		sizeof(addr_data_pair_custom4_s5kjn1acc2) / sizeof(kal_uint16));
}
...
/* A06 code for SR-AL7160A-01-502 by hanhaoran at 20240410 start */
extern int hbb_flag;
#define S5KJN1_EEPROM_VENDORID 0x51
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_set_test_pattern_s5kjn1acc2[] = {
	0x0200, 0x0002, 0x0202, 0x0002, 0x0204, 0x0020, 0x020E, 0x0100,
	0x0210, 0x0100, 0x0212, 0x0100, 0x0214, 0x0100, 0x0600, 0x0002,
};
#endif
/* A06V code for SR-AL6528V-01-225 by hanhaoran at 2024/11/14 start */
static kal_uint32 set_test_pattern_mode(kal_uint32 modes, struct SET_SENSOR_PATTERN_SOLID_COLOR *pdata)
{
	...
	LOG_INF("modes: %d\n", modes);
	if (modes) {
		if((modes == 1 || modes == 5) && (pdata != NULL)){ // solid color
...
/* A06 code for SR-AL7160A-01-539 by jiangwenhan at 20240603 start*/
	case SENSOR_FEATURE_GET_PDAF_INFO:
		...
		case MSDK_SCENARIO_ID_SLIM_VIDEO:
		    memcpy((void *)PDAFinfo,
			       (void *)&imgsensor_pd_info_16_9_1920x1080,
			       sizeof(struct SET_PD_BLOCK_INFO_T));
			break;
		case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
		  memcpy((void *)PDAFinfo,
...
UINT32
A0601LYBACKS5KJN1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	LOG_INF("A0601LYBACKS5KJN1_MIPI_RAW_SensorInit in  fufu\n");
...
/* A06V code for SR-AL6528V-01-225 by hanhaoran at 2024/11/14 end */