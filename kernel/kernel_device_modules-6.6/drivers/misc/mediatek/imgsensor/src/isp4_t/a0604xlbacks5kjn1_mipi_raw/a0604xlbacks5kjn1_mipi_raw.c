...
#include "a0604xlbacks5kjn1_mipi_raw.h"
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_s5kjn1acc5[] = {
	0x6226, 0x0001,
	0x6028, 0x2400,
	0x602A, 0x801C,
	0x6F12, 0x1743,
...
static void sensor_init(void)
{
	...
	mdelay(5);
	s5kjn1_multi_write_cmos_sensor(addr_data_pair_init_s5kjn1acc5,
				       sizeof(addr_data_pair_init_s5kjn1acc5) /
					       sizeof(kal_uint16));
#if EEPROM_READY //stan
if(eeprom_enable == 1)
{
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_s5kjn1acc5[] = {	//4080*3072 30fps
	0xFCFC, 0x2400,
	0x0710, 0x0002,
	0x0712, 0x0804,
	0x0714, 0x0100,
...
static void preview_setting(void)
{
	...
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_preview_s5kjn1acc5,
		sizeof(addr_data_pair_preview_s5kjn1acc5) / sizeof(kal_uint16));
}
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_s5kjn1acc5[] = {	//2000*1132 120fps
    0xFCFC, 0x2400,
	0x0710, 0x0004,
	0x0712, 0x0401,
	0x0714, 0x0100,
...
static void hs_video_setting(void) /// 120fps
{
	...
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_hs_video_s5kjn1acc5,
		sizeof(addr_data_pair_hs_video_s5kjn1acc5) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_s5kjn1acc5[] = {	//4080*3072 30fps
	0xFCFC, 0x2400,
	0x0710, 0x0002,
	0x0712, 0x0804,
	0x0714, 0x0100,
...
static void capture_setting(kal_uint16 currefps)
{
	LOG_INF("start\n");
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_capture_s5kjn1acc5,
		sizeof(addr_data_pair_capture_s5kjn1acc5) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_normal_video_s5kjn1acc5[] = {	//4080*3072 30fps
	0xFCFC, 0x2400,
	0x0710, 0x0002,
	0x0712, 0x0804,
	0x0714, 0x0100,
...
static void normal_video_setting(kal_uint16 currefps) // 30fps
{
	...
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_normal_video_s5kjn1acc5,
		sizeof(addr_data_pair_normal_video_s5kjn1acc5) /
			sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_s5kjn1acc5[] = {	//1920*1080 30fps
    0xFCFC, 0x2400,
	0x0710, 0x0004,
	0x0712, 0x0401,
	0x0714, 0x0100,
...
static void slim_video_setting(void) //60fps
{
	...
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_slim_video_s5kjn1acc5,
		sizeof(addr_data_pair_slim_video_s5kjn1acc5) /
			sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_s5kjn1acc5[] = {	//3264*1836 24fps
...
static void custom1_setting(void)
{
	LOG_INF("E\n");
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_custom1_s5kjn1acc5,
		sizeof(addr_data_pair_custom1_s5kjn1acc5) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custom2_s5kjn1acc5[] = {	//4080*3072 24fps
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static void custom2_setting(void)
{
	LOG_INF("E\n");
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_custom2_s5kjn1acc5,
		sizeof(addr_data_pair_custom2_s5kjn1acc5) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custom3_s5kjn1acc5[] = {	//3840*2160 60fps
	0xFCFC, 0x2400,
	0x0710, 0x0002,
	0x0712, 0x0804,
	0x0714, 0x0100,
...
static void custom3_setting(void)
{
	LOG_INF("E\n");
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_custom3_s5kjn1acc5,
		sizeof(addr_data_pair_custom3_s5kjn1acc5) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custom4_s5kjn1acc5[] = {	//8160*6144 10fps
	0xFCFC, 0x2400,
	0x0710, 0x0010,
	0x0712, 0x0201,
	0x0714, 0x0800,
...
static void custom4_setting(void)
{
	LOG_INF("E\n");
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_custom4_s5kjn1acc5,
		sizeof(addr_data_pair_custom4_s5kjn1acc5) / sizeof(kal_uint16));
}
...
extern int hbb_flag;
#define S5KJN1_EEPROM_VENDORID 0x54
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_set_test_pattern_s5kjn1acc5[] = {
...
UINT32
A0604XLBACKS5KJN1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	LOG_INF("A0604XLBACKS5KJN1_MIPI_RAW_SensorInit in  fufu\n");
