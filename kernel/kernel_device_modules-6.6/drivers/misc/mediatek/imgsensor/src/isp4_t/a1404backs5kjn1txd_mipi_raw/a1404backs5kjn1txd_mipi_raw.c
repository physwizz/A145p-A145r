...
#include "a1404backs5kjn1txd_mipi_raw.h"

/*hs14 code for AL6528ADEU-2675 by liluling at 2022-11-22 start*/
// hs14 code for SR-AL6528V-01-225 by zhaoziyu at 2024/09/02 start
// hs14 code for SR-AL6528V-01-216 by jiangwenhan at 2024/09/24 start
#define FPTPDAFSUPPORT 1
// hs14 code for SR-AL6528V-01-225 by zhaoziyu at 2024/09/02 end
// hs14 code for SR-AL6528V-01-216 by jiangwenhan at 2024/09/24 end
#define MULTI_WRITE 1
#define OTP_DATA_NUMBER 9

#define PFX "A1404BACKS5KJN1TXD_MIPI_RAW_camera_sensor"

#define LOG_INF(format, args...) pr_err(PFX "[%s] " format, __func__, ##args)
static DEFINE_SPINLOCK(imgsensor_drv_lock);
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = A1404BACKS5KJN1TXD_SENSOR_ID ,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_s5kjn1acc1[] = {
...
static void sensor_init(void)
{
	...
	mdelay(10);
	s5kjn1_multi_write_cmos_sensor(addr_data_pair_init_s5kjn1acc1,
				       sizeof(addr_data_pair_init_s5kjn1acc1) /
					       sizeof(kal_uint16));
#if EEPROM_READY //stan
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_s5kjn1acc1[] = {
0x6028,	0x2400,
0x602A,	0x1A28,
0x6F12,	0x4C00,
0x602A,	0x065A,
...
static void preview_setting(void)
{
	...
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_preview_s5kjn1acc1,
		sizeof(addr_data_pair_preview_s5kjn1acc1) / sizeof(kal_uint16));
}
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_s5kjn1acc1[] = {
    0x6028, 0x2400,
    0x602A, 0x1A28,
    0x6F12, 0x4C00,
    0x602A, 0x065A,
...
static void hs_video_setting(void) /// 120fps
{
	...
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_hs_video_s5kjn1acc1,
		sizeof(addr_data_pair_hs_video_s5kjn1acc1) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_s5kjn1acc1[] = {
0x6028,	0x2400,
0x602A,	0x1A28,
0x6F12,	0x4C00,
0x602A,	0x065A,
...
static void capture_setting(kal_uint16 currefps)
{
	LOG_INF("start\n");
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_capture_s5kjn1acc1,
		sizeof(addr_data_pair_capture_s5kjn1acc1) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_normal_video_s5kjn1acc1[] = {
0x6028,	0x2400,
0x602A,	0x1A28,
0x6F12,	0x4C00,
0x602A,	0x065A,
...
static void normal_video_setting(kal_uint16 currefps) // 30fps
{
	...
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_normal_video_s5kjn1acc1,
		sizeof(addr_data_pair_normal_video_s5kjn1acc1) /
			sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_s5kjn1acc1[] = {
    0x6028, 0x2400,
    0x602A, 0x1A28,
    0x6F12, 0x4C00,
    0x602A, 0x065A,
...
static void slim_video_setting(void) //60fps
{
	...
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_slim_video_s5kjn1acc1,
		sizeof(addr_data_pair_slim_video_s5kjn1acc1) /
			sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_s5kjn1acc1[] = {
...
static void custom1_setting(void)
{
	LOG_INF("E\n");
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_custom1_s5kjn1acc1,
		sizeof(addr_data_pair_custom1_s5kjn1acc1) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custom2_s5kjn1acc1[] = {
0x6028, 0x2400,
0x602A, 0x1A28,
0x6F12, 0x4C00,
0x602A, 0x065A,
...
static void custom2_setting(void)
{
	LOG_INF("E\n");
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_custom2_s5kjn1acc1,
		sizeof(addr_data_pair_custom2_s5kjn1acc1) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custom3_s5kjn1acc1[] = {
	0x6028, 0x2400, 0x602A, 0x1A28, 0x6F12, 0x4C00, 0x602A, 0x065A, 0x6F12,
	0x0000, 0x602A, 0x139E, 0x6F12, 0x0100, 0x602A, 0x139C, 0x6F12, 0x0000,
	0x602A, 0x13A0, 0x6F12, 0x0A00, 0x6F12, 0x0120, 0x602A, 0x2072, 0x6F12,
	0x0000, 0x602A, 0x1A64, 0x6F12, 0x0301, 0x6F12, 0xFF00, 0x602A, 0x19E6,
...
static void custom3_setting(void)
{
	LOG_INF("E\n");
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_custom3_s5kjn1acc1,
		sizeof(addr_data_pair_custom3_s5kjn1acc1) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custom4_s5kjn1acc1[] = {
0x6028, 0x2400,
0x602A, 0x1A28,
0x6F12, 0x4C00,
0x602A, 0x065A,
...
static void custom4_setting(void)
{
	LOG_INF("E\n");
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_custom4_s5kjn1acc1,
		sizeof(addr_data_pair_custom4_s5kjn1acc1) / sizeof(kal_uint16));
}
...
*************************************************************************/
extern int hbb_flag;
#define S5KJN1_EEPROM_VENDORID 0x06
// hs14 code for SR-AL6528V-01-225 by zhaoziyu at 2024/09/02 start
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_set_test_pattern_s5kjn1acc1[] = {
	0x0200, 0x0002, 0x0202, 0x0002, 0x0204, 0x0020, 0x020E, 0x0100,
	0x0210, 0x0100, 0x0212, 0x0100, 0x0214, 0x0100, 0x0600, 0x0002,
};
#endif

/* o22V code  for SR-AL7160V-01-220 by dingling at 2024/12/14 start */
...
/* o22V code  for SR-AL7160V-01-220 by dingling at 2024/12/14 end */
...
UINT32
A1404BACKS5KJN1TXD_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	LOG_INF("A1404BACKS5KJN1TXD_MIPI_RAW_SensorInit in  fufu\n");
