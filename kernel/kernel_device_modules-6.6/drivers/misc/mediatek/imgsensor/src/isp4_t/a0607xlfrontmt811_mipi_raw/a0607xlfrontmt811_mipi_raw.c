...
#include "a0607xlfrontmt811_mipi_raw.h"
/* A06 code for SR-AL7160A-01-502 by xuyunhui at 20240628 start */
#define PFX "a0607xlfrontmt811_mipi_raw"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = A0607XLFRONTMT811_SENSOR_ID,
        ...
        do
        {
            ...
            *sensor_id = ((read_cmos_sensor(0x0000) << 8) | read_cmos_sensor(0x0001)) + 3;
            if (*sensor_id == imgsensor_info.sensor_id)
            {
                ...
                if(mt811VendorId != 0x00 && mt811VendorId != 0x87){
...
UINT32 A0607XLFRONTMT811_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT  **pfFunc)
{
    LOG_INF("A0607XLFRONTMT811_MIPI_RAW_SensorInit\n");
    if (pfFunc!=NULL)
            *pfFunc=&sensor_func;
    return ERROR_NONE;
}
