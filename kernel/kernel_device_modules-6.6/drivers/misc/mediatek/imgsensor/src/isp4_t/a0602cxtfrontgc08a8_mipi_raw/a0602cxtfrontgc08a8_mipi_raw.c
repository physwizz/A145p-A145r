 ...
 *============================================================================
 *
 * Version:  V20240320134022 by GC-S-TEAM
 *
...
#include "a0602cxtfrontgc08a8_mipi_raw.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc08a8_camera_sensor"
#define LOG_1 LOG_INF("a0602cxtfrontgc08a8, MIPI 4LANE\n")
/****************************   Modify end    *******************************************/
...
/* A06 code for SR-AL7160A-01-502 by xuyunhui at 20240626 start */
/* a06 code for SR-AL7160A-01-530 by pengxutao at 20240424 start */
/* A06 code for SR-AL7160A-01-501 by wangtao at 20240517 start */
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = A0602CXTFRONTGC08A8_SENSOR_ID,
	...
	.isp_driving_current = ISP_DRIVING_2MA,  //mclk 驱动电流 2mA
...
/* A06 code for SR-AL7160A-01-502 by xuyunhui at 20240626 end */
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				pr_debug("[gc08a8_camera_sensor]get_imgsensor_id:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, *sensor_id);
				return ERROR_NONE;
			}
			pr_debug("[gc08a8_camera_sensor]get_imgsensor_id:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
...
UINT32 A0602CXTFRONTGC08A8_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
...
/* a06 code for SR-AL7160A-01-530 by pengxutao at 20240424 end */
