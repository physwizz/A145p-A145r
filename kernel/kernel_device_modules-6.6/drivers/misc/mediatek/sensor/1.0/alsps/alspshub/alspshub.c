...
struct alspshub_ipi_data {
	...
	int		ps_cali;
	atomic_t	als_cali;
/*a06 code for AL7160AV-10 by zhawei at 20240826 start*/
#ifdef CONFIG_HQ_PROJECT_O8
	atomic_t	als_dim;
#endif    //CONFIG_HQ_PROJECT_O8
/*a06 code for AL7160AV-10 by zhawei at 20240826 end*/
...
/*a06 code for SR-AL7160V-01-19|SR-AL6528V-01-177|AL7160AV-10 by zhawei at 20240826 start*/
...
static void lcd_info_judge(uint8_t *data)
{
	...
	if (!chosen) {
		...
		if (of_property_read_string(chosen, "bootargs", &command_line)) {
			pr_err("%s: failed to get cmdline", __func__);
			of_node_put(chosen);
		} else {
...
#endif    //CONFIG_HQ_PROJECT_O8
/*a06 code for SR-AL7160V-01-19|SR-AL6528V-01-177|AL7160AV-10 by zhawei at 20240826 end*/
