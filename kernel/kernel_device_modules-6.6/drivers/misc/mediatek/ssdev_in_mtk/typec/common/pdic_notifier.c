...
EXPORT_SYMBOL(PDIC_NOTI_DEST_Print);
...
EXPORT_SYMBOL(PDIC_NOTI_ID_Print);
...
EXPORT_SYMBOL(PDIC_NOTI_RID_Print);
...
EXPORT_SYMBOL(PDIC_NOTI_USB_STATUS_Print);
...
EXPORT_SYMBOL(PDIC_NOTI_PIN_STATUS_Print);
...
MODULE_AUTHOR("Samsung PDIC");
MODULE_DESCRIPTION("USB PDIC Notifier");
MODULE_LICENSE("GPL");
