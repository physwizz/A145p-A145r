/*
 driver/usbpd/usbpd_pd.c - USB PD(Power Delivery) device driver
 *
...
#include <linux/usb/typec/slsi/usbpd_ext.h>
#endif
#include <linux/usb/typec/slsi/usbpd.h>

#if IS_ENABLED(CONFIG_PDIC_S2MU004)
#include <linux/usb/typec/slsi/usbpd-s2mu004.h>
#elif IS_ENABLED(CONFIG_PDIC_S2MU106)
#include <linux/usb/typec/slsi/usbpd-s2mu106.h>
#elif IS_ENABLED(CONFIG_PDIC_S2MU205)
#include <linux/usb/typec/slsi/usbpd-s2mu205.h>
#elif IS_ENABLED(CONFIG_PDIC_S2MU107)
#include <linux/usb/typec/slsi/usbpd-s2mu107.h>
#elif IS_ENABLED(CONFIG_PDIC_S2MM005)
#include <linux/usb/typec/slsi/usbpd-s2mu107.h>
#endif
...
#if IS_ENABLED(CONFIG_MUIC_SUPPORT_PDIC_OTG_CTRL)
