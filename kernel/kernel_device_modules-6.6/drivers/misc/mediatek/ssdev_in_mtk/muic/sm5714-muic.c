...
#include <linux/ssdev_in_mtk/wakelock.h>

#include <linux/ssdev_in_mtk/sec_batt.h>
#if IS_ENABLED(CONFIG_ARCH_QCOM) && !defined(CONFIG_ARCH_MEDIATEK)
#include <linux/ssdev_in_mtk/sec_param.h>
#else
#include <linux/ssdev_in_mtk/sec_ext.h>
#endif
...
#include <linux/ssdev_in_mtk/muic/sm5714-muic.h>
...
extern struct muic_platform_data g_muic_pdata;
...
MODULE_LICENSE("GPL");
MODULE_SOFTDEP("pre: mod-core-muic");
