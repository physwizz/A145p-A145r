...
#if IS_ENABLED(CONFIG_BATTERY_SAMSUNG_LEGO_STYLE)
#include "../battery/common/include/sec_charging_common.h"
#else
#include "../battery_v2/include/sec_charging_common.h"
#endif
#endif
#if IS_ENABLED(CONFIG_MUIC_SUPPORT_SEC_EXT)
...
int muic_sysfs_init(struct muic_platform_data *muic_pdata)
{
	...
	if (muic_pdata->switch_device == NULL)
		muic_pdata->switch_device = (struct device *) sec_device_create(NULL, "switch");
...
EXPORT_SYMBOL(muic_sysfs_deinit);
MODULE_LICENSE("GPL");
