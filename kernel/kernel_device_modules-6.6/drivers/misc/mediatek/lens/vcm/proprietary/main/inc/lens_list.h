...
// A06 code for SR-AL7160A by wangtao at 20240902 start
// A06 code for SR-AL7160A-01-502 by xuyunhui at 20240905 start
/*****************************O8 camera af define start ***************************************/
#ifdef CONFIG_HQ_PROJECT_O8
//ADD AF for A0601
#define A0601GT9778AF_SetI2Cclient A0601GT9778AF_SetI2Cclient_Main
#define A0601GT9778AF_Ioctl A0601GT9778AF_Ioctl_Main
#define A0601GT9778AF_Release A0601GT9778AF_Release_Main
#define A0601GT9778AF_GetFileName A0601GT9778AF_GetFileName_Main
extern int A0601GT9778AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long A0601GT9778AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			unsigned long a_u4Param);
extern int A0601GT9778AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int A0601GT9778AF_GetFileName(unsigned char *pFileName);

//ADD AF for A0602
#define A0602GT9778AF_SetI2Cclient A0602GT9778AF_SetI2Cclient_Main
#define A0602GT9778AF_Ioctl A0602GT9778AF_Ioctl_Main
#define A0602GT9778AF_Release A0602GT9778AF_Release_Main
#define A0602GT9778AF_GetFileName A0602GT9778AF_GetFileName_Main
extern int A0602GT9778AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long A0602GT9778AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			unsigned long a_u4Param);
extern int A0602GT9778AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int A0602GT9778AF_GetFileName(unsigned char *pFileName);

//ADD AF for A0603
#define A0603GT9778AF_SetI2Cclient A0603GT9778AF_SetI2Cclient_Main
#define A0603GT9778AF_Ioctl A0603GT9778AF_Ioctl_Main
#define A0603GT9778AF_Release A0603GT9778AF_Release_Main
#define A0603GT9778AF_GetFileName A0603GT9778AF_GetFileName_Main
extern int A0603GT9778AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long A0603GT9778AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			unsigned long a_u4Param);
extern int A0603GT9778AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int A0603GT9778AF_GetFileName(unsigned char *pFileName);

//ADD AF for A0604
#define A0604GT9778AF_SetI2Cclient A0604GT9778AF_SetI2Cclient_Main
#define A0604GT9778AF_Ioctl A0604GT9778AF_Ioctl_Main
#define A0604GT9778AF_Release A0604GT9778AF_Release_Main
#define A0604GT9778AF_GetFileName A0604GT9778AF_GetFileName_Main
extern int A0604GT9778AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long A0604GT9778AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			unsigned long a_u4Param);
extern int A0604GT9778AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int A0604GT9778AF_GetFileName(unsigned char *pFileName);

//ADD AF for A0605
#define A0605GT9778AF_SetI2Cclient A0605GT9778AF_SetI2Cclient_Main
#define A0605GT9778AF_Ioctl A0605GT9778AF_Ioctl_Main
#define A0605GT9778AF_Release A0605GT9778AF_Release_Main
#define A0605GT9778AF_GetFileName A0605GT9778AF_GetFileName_Main
extern int A0605GT9778AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long A0605GT9778AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			unsigned long a_u4Param);
extern int A0605GT9778AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int A0605GT9778AF_GetFileName(unsigned char *pFileName);
#endif
/*****************************O8 camera af define end***************************************/
// A06 code for SR-AL7160A-01-502 by xuyunhui at 20240905 end
// A06 code for SR-AL7160A by wangtao at 20240902 end

/*hs14 code for SR-AL6528V-01-224 by jiangwenhan at 2024/09/05 start*/
/*****************************hs14 camera af define start *******************************/
...
#define A1401AW8601WAF_GetFileName A1401AW8601WAF_GetFileName_Main
extern int A1401AW8601WAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long A1401AW8601WAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
				unsigned long a_u4Param);
extern int A1401AW8601WAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int A1401AW8601WAF_GetFileName(unsigned char *pFileName);

//ADD AF for A1402
#define A1402DW9767AF_SetI2Cclient A1402DW9767AF_SetI2Cclient_Main
#define A1402DW9767AF_Ioctl A1402DW9767AF_Ioctl_Main
#define A1402DW9767AF_Release A1402DW9767AF_Release_Main
#define A1402DW9767AF_GetFileName A1402DW9767AF_GetFileName_Main
extern int A1402DW9767AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long A1402DW9767AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
				unsigned long a_u4Param);
extern int A1402DW9767AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int A1402DW9767AF_GetFileName(unsigned char *pFileName);

//ADD AF for A1403
#define A1403GT9778AF_SetI2Cclient A1403GT9778AF_SetI2Cclient_Main
#define A1403GT9778AF_Ioctl A1403GT9778AF_Ioctl_Main
#define A1403GT9778AF_Release A1403GT9778AF_Release_Main
#define A1403GT9778AF_PowerDown A1403GT9778AF_PowerDown_Main
#define A1403GT9778AF_GetFileName A1403GT9778AF_GetFileName_Main
extern int A1403GT9778AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long A1403GT9778AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
				unsigned long a_u4Param);
extern int A1403GT9778AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
...
#endif
/*****************************hs14 camera af define end******************************/
/*hs14 code for SR-AL6528V-01-224 by jiangwenhan at 2024/09/05 end*/
