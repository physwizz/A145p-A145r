...
/*
 * A0601GT9778AF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "A0601GT9778AF_DRV"
...
static u8 read_data(u8 addr)
{
	...
	LOG_INF("[A0601GT9778AF]  get_byte %d\n", get_byte);
	return get_byte;
}
...
static int s4AF_ReadReg(unsigned short *a_pu2Result)
{
	...
	*a_pu2Result = (read_data(0x03) << 8) + (read_data(0x04) & 0xff);
	printk("[A0601GT9778AF]  s4A0601GT9778AF_ReadReg %d\n", *a_pu2Result);
	return 0;
}
...
/* ////////////////////////////////////////////////////////////// */
long A0601GT9778AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int A0601GT9778AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	int Ret = 0;
...
int A0601GT9778AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int A0601GT9778AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int A0601GT9778AF_GetFileName(unsigned char *pFileName)
{
