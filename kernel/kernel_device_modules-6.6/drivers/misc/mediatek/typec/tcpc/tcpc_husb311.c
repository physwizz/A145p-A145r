...
/*A14_V code for SR-AL6528V-01-117 by gaoxugang at 20240829 start*/
#if 0
...
#endif
/*A14_V code for SR-AL6528V-01-117 by gaoxugang at 20240829 end*/
...
/*A14 code for R-AL6528V-01-111 by chenyulin at 20240911 start*/
...
#endif
/*A14 code for R-AL6528V-01-111 by chenyulin at 20240911 end*/
...
/*A14 code for SR-AL6528V-01-117 by gaoxugang at 20240903 start*/
int husb311_get_alert_status(struct tcpc_device *tcpc, uint32_t *alert, uint32_t *mask)
{
	struct husb311_chip *chip = tcpc_get_dev_data(tcpc);
	int ret;
	uint8_t buf[4] = {0}; 

	ret = husb311_block_read(chip->client, TCPC_V10_REG_ALERT, 4, buf); 
	if (ret < 0)
		return ret;
	...
	*mask = le16_to_cpu(*(uint16_t *)&buf[2]);
	...
	ret = husb311_block_read(chip->client, HUSB311_REG_HUSB_INT, 2, buf);
	if (ret < 0)
		return ret;
	*alert |= buf[0] << 16;
	*mask |= buf[1] << 16;
...
//#ifdef CONFIG_TCPC_VSAFE0V_DETECT_IC
	...
	tcpc->vbus_safe0v = !!(ret & HUSB311_REG_VBUS_80);
...
static struct tcpc_ops husb311_tcpc_ops = {
	...
	.get_alert_status_and_mask = husb311_get_alert_status,
...
static void husb311_i2c_remove(struct i2c_client *client);
...
/*A14 code for R-AL6528V-01-111 by chenyulin at 20240911 start*/
#if IS_ENABLED(CONFIG_HQ_PROJECT_O22)
	gxy_bat_set_tcpcinfo(GXY_BAT_TCPC_INFO_HUSB311);
#endif
/*A14 code for R-AL6528V-01-111 by chenyulin at 20240911 end*/
