...
#define AW35615_DRIVER_VERSION        "V1.3.5"
...
int aw35615_get_alert_status(struct tcpc_device *tcpc, uint32_t *alert, uint32_t *mask)
{
    AW_LOG("enter\n");
    return 0;
}
...
static struct tcpc_ops aw35615_tcpc_ops = {
    ...
    .get_alert_status_and_mask = aw35615_get_alert_status,
