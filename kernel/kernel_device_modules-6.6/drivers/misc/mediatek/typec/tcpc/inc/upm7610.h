...
#define UPM7610_REG_TRIM_C4					(0xC4)
#define UPM7610_REG_TRIM_C5					(0xC5)
...
/*
 * UPM7610_REG_RESET_CTRL (0xA0)
 */
#define UPM7610_REG_EXT_STATUS_MASK_CTRL		(1<<6)
#define UPM7610_REG_CABLE_RESET_CTRL		    (1<<5)
#define UPM7610_REG_HARD_RESET_CTRL		        (1<<4)
#define UPM7610_REG_SOFT_RESET          		(1<<0)
