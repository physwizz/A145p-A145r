 ...
 *
 *********************************************************/
extern void gxy_bat_set_tcpcinfo(enum gxy_bat_tcpc_info cinfo_data);
/*A14 code for SR-AL6528V-01-112 by at 20240913 end*/
...
//#endif
	...
	pr_err("FUSB  %s - Device check passed!\n", __func__);
...
//#endif
	...
	*  Interrupt must be enabled before starting 302 initialization */
	...
	/*A14 code for SR-AL6528V-01-112 by chenyulin at 20240913 start*/
	gxy_bat_set_tcpcinfo(GXY_BAT_TCPC_INFO_FUSB302B);
