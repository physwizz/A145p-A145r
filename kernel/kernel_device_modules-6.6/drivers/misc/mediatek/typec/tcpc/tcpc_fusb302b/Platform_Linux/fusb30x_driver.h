...
static void fusb30x_remove(struct i2c_client* client);													// Called when the associated device is removed
...
#ifdef CONFIG_PM
static SIMPLE_DEV_PM_OPS(fusb30x_dev_pm_ops, fusb302_i2c_suspend, fusb302_i2c_resume);
