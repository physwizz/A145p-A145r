...
/*A06_V code for AL7160AV-521 by yuli at 20250421 start*/
#endif//BSP_SIL_QCOM_SPECIAL

#if IS_ENABLED(CONFIG_DRM_MEDIATEK_V2)
  #define SIL_EVENT_BLANK         MTK_DISP_EVENT_BLANK
  #define SIL_EVENT_UNBLANK       MTK_DISP_BLANK_UNBLANK
  #define SIL_EVENT_POWERDOWN     MTK_DISP_BLANK_POWERDOWN
  #define SIL_REGISTER_CLIENT(a)  do{ mtk_disp_notifier_register("Silead Fingerprint",a); }while(0)
#endif//CONFIG_DRM_MEDIATEK_V2
