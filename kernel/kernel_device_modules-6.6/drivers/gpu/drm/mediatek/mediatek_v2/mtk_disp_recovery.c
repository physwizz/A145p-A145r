...
/*a14 code for AL6528AV-11 by zhengkunbang at 20240914 start*/
extern bool lcm_detect_panel(const char *lcm_name);
/*a14 code for AL6528AV-11 by zhengkunbang at 20240914 end*/
...
/*a14 code for AL6528AV-11 by zhengkunbang at 20240914 start*/
			...
			if (lcm_detect_panel("lcd_jd9522t_xx_boe_mipi_fhd_video")) {
				if (((i%2) == 0) && (i > 0)) {
					DDPPR_ERR(
