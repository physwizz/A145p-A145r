...
static void lcm_deep_standby_setting(struct lcm *ctx)
{
...
static void lcm_panel_init(struct lcm *ctx)
{
    ...
    lcm_dcs_write_seq_static(ctx, 0xB1, 0x2C, 0x37, 0x37, 0x33, 0x33, 0x22, 0x43, 0x57, 0x1A, 0x1A, 0x0C, 0x98, 0x21, 0x11, 0x46, 0x34, 0x64, 0x24);
    lcm_dcs_write_seq_static(ctx, 0xB2, 0x00, 0x26, 0xD0, 0x40, 0x00, 0x26, 0xBA, 0x20, 0x98, 0x11, 0x01, 0x00, 0x00, 0x50, 0x22, 0xDF);
    lcm_dcs_write_seq_static(ctx, 0xB4, 0x5A, 0x5A, 0x5A, 0x5A, 0x5A, 0x5A, 0x90, 0x5A, 0x90, 0x5A, 0x07, 0x8D, 0x01, 0x02);
    ...
    lcm_dcs_write_seq_static(ctx, 0xCB, 0x13, 0x08, 0xE0, 0x0E, 0x79);
    lcm_dcs_write_seq_static(ctx, 0xD1, 0x27, 0x02, 0x0C, 0x5F, 0x01);
    lcm_dcs_write_seq_static(ctx, 0xD2, 0x00, 0x00, 0x00, 0x00);
    lcm_dcs_write_seq_static(ctx, 0xD3, 0xC0, 0x00, 0x10, 0x10, 0x00, 0x00, 0x4F, 0x4F, 0x44, 0x4B, 0x24, 0x24, 0x24, 0x24, 0x32, 0x10, 0x20, 0x00, 0x20, 0x32, 0x16, 0x64, 0x06, 0x64, 0x32, 0x16, 0x6A, 0x06, 0x6A, 0x00, 0x00);
    lcm_dcs_write_seq_static(ctx, 0xD5, 0x18, 0x18, 0x18, 0x18, 0x28, 0x29, 0x24, 0x25, 0x1E, 0x1E, 0x1F, 0x1F, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x20, 0x21, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18);
    lcm_dcs_write_seq_static(ctx, 0xD6, 0x18, 0x18, 0x18, 0x18, 0x29, 0x28, 0x21, 0x20, 0x1E, 0x1E, 0x1F, 0x1F, 0x0F, 0x0E, 0x0D, 0x0C, 0x0B, 0x0A, 0x09, 0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01, 0x00, 0x25, 0x24, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18);
    lcm_dcs_write_seq_static(ctx, 0xD8, 0xAA, 0xAA, 0xAA, 0xA8, 0x00, 0x00, 0xAA, 0xAA, 0xAA, 0xA8, 0x00, 0x00, 0xAA, 0xEA, 0xAA, 0xA8, 0x00, 0x00, 0xAA, 0xEA, 0xAA, 0xA8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
    lcm_dcs_write_seq_static(ctx, 0xE0, 0x00, 0x02, 0x08, 0x0D, 0x12, 0x19, 0x2E, 0x33, 0x39, 0x35, 0x50, 0x58, 0x60, 0x72, 0x73, 0x7E, 0x89, 0x9E, 0x9F, 0x4F, 0x57, 0x61, 0x64, 0x00, 0x02, 0x08, 0x0D, 0x12, 0x19, 0x2E, 0x33, 0x39, 0x35, 0x50, 0x58, 0x60, 0x72, 0x73, 0x7E, 0x89, 0x9E, 0x9F, 0x4F, 0x57, 0x63, 0x79);
    lcm_dcs_write_seq_static(ctx, 0xE7, 0x07, 0x14, 0x14, 0x0B, 0x0F, 0x84, 0x00, 0x3C, 0x3C, 0x32, 0x32, 0x00, 0x00, 0x00, 0x00, 0x98, 0x10, 0x01, 0x02);
    ...
    lcm_dcs_write_seq_static(ctx, 0xE9, 0xC6);
    lcm_dcs_write_seq_static(ctx, 0xD2, 0x1F, 0x3E);
    lcm_dcs_write_seq_static(ctx, 0xE9, 0x3F);
    lcm_dcs_write_seq_static(ctx, 0xE9, 0xC4);
    lcm_dcs_write_seq_static(ctx, 0xD2, 0x3C, 0x00);
    lcm_dcs_write_seq_static(ctx, 0xE9, 0x3F);
    lcm_dcs_write_seq_static(ctx, 0xD3, 0x00, 0x04, 0x00, 0x20, 0x00, 0x00, 0x00, 0x80, 0x04);
    lcm_dcs_write_seq_static(ctx, 0xD8, 0xFF, 0xFF, 0xFF, 0xFC, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
    lcm_dcs_write_seq_static(ctx, 0xE7, 0x01, 0x00, 0x48, 0x01, 0x48, 0x13, 0x48, 0x14, 0x00, 0x00, 0x1B, 0x00, 0x00);
    ...
    lcm_dcs_write_seq_static(ctx, 0xD8, 0xAA, 0xFA, 0xAA, 0xAA, 0xAA, 0xA0, 0xAA, 0xFA, 0xAA, 0xAA, 0xAA, 0xA0, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xA0, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xA0);
    lcm_dcs_write_seq_static(ctx, 0xBD, 0x00);
...
static int lcm_prepare(struct drm_panel *panel)
{
    ...
    if(g_smart_wakeup_flag) {
        lcm_deep_standby_setting(ctx);
        gpiod_set_value(ctx->reset_gpio, 1);
        mdelay(5);
        gpiod_set_value(ctx->reset_gpio, 0);
        mdelay(2);
        gpiod_set_value(ctx->reset_gpio, 1);
        pr_info("[LCM]deep_standby lcd_rst last high\n");
        mdelay(20);
    }
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
    ...
    pr_info("%s+ lcm, hx83108b_ls_inx\n", __func__);

    if (!lcm_detect_panel("hx83108b_ls_inx")) {
        return -ENODEV;
    }
