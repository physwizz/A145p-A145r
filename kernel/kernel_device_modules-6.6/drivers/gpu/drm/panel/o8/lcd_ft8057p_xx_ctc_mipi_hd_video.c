...
static void lcm_suspend_setting(struct lcm *ctx)//lcm_aot_suspend_setting
{
...
static void lcm_panel_init(struct lcm *ctx)
{
    ...
    lcm_dcs_write_seq_static(ctx, 0x00,0x00);
    lcm_dcs_write_seq_static(ctx, 0x2B,0x00,0x00,0x06,0x3F);
    ...
    lcm_dcs_write_seq_static(ctx, 0x00,0x00);
    lcm_dcs_write_seq_static(ctx, 0xD8,0x31,0x31);
    ...
    lcm_dcs_write_seq_static(ctx, 0x00,0x00);
    lcm_dcs_write_seq_static(ctx, 0xE1,0x0D,0x29,0x2B,0x3E,0x4A,0x56,0x6A,0x79,0x7A,0x86,0x88,0x9C,0x6A,0x57,0x59,0x50);
    lcm_dcs_write_seq_static(ctx, 0x00,0x10);
    lcm_dcs_write_seq_static(ctx, 0xE1,0x49,0x3F,0x33,0x29,0x21,0x14,0x17,0x14);
    lcm_dcs_write_seq_static(ctx, 0x00,0x00);
    lcm_dcs_write_seq_static(ctx, 0xE2,0x0D,0x29,0x2B,0x3E,0x4A,0x56,0x6A,0x79,0x7A,0x86,0x88,0x9C,0x6A,0x57,0x59,0x50);
    lcm_dcs_write_seq_static(ctx, 0x00,0x10);
    lcm_dcs_write_seq_static(ctx, 0xE2,0x49,0x3F,0x33,0x29,0x21,0x14,0x17,0x14);
    lcm_dcs_write_seq_static(ctx, 0x00,0x80);
    lcm_dcs_write_seq_static(ctx, 0xC0,0x00,0xFC,0x00,0xC0,0x00,0x10);
    lcm_dcs_write_seq_static(ctx, 0x00,0x90);
    lcm_dcs_write_seq_static(ctx, 0xC0,0x00,0xFC,0x00,0xC0,0x00,0x10);
    lcm_dcs_write_seq_static(ctx, 0x00,0xA0);
    lcm_dcs_write_seq_static(ctx, 0xC0,0x00,0xFC,0x00,0xC0,0x00,0x10);
    lcm_dcs_write_seq_static(ctx, 0x00,0xB0);
    lcm_dcs_write_seq_static(ctx, 0xC0,0x00,0xFD,0x00,0xC0,0x10);
    lcm_dcs_write_seq_static(ctx, 0x00,0xC1);
    lcm_dcs_write_seq_static(ctx, 0xC0,0x00,0xB4,0x00,0xAB,0x00,0x78,0x01,0x00);
    lcm_dcs_write_seq_static(ctx, 0x00,0x70);
    lcm_dcs_write_seq_static(ctx, 0xC0,0x00,0xFC,0x00,0xC0,0x00,0x10);
    lcm_dcs_write_seq_static(ctx, 0x00,0xA3);
    lcm_dcs_write_seq_static(ctx, 0xC1,0x00,0x2E,0x00,0x2E,0x00,0x02);
    lcm_dcs_write_seq_static(ctx, 0x00,0xB7);
    lcm_dcs_write_seq_static(ctx, 0xC1,0x00,0x2E);
    lcm_dcs_write_seq_static(ctx, 0x00,0x73);
    lcm_dcs_write_seq_static(ctx, 0xCE,0x0A,0x09);
    lcm_dcs_write_seq_static(ctx, 0x00,0x80);
    lcm_dcs_write_seq_static(ctx, 0xCE,0x01,0x81,0x09,0x09,0x00,0x67,0x00,0x96,0x00,0x64,0x00,0x96,0x00,0x67,0x00,0x96);
    lcm_dcs_write_seq_static(ctx, 0x00,0x90);
    lcm_dcs_write_seq_static(ctx, 0xCE,0x00,0xA5,0x16,0x8F,0x00,0xA5,0x80,0x09,0x09,0x00,0x07,0xD0,0x11,0x11,0x11);
    lcm_dcs_write_seq_static(ctx, 0x00,0xA0);
    ...
    lcm_dcs_write_seq_static(ctx, 0xCE,0x06,0x03,0x39,0x04,0x4C,0x02,0xCB,0x00,0x00,0x00,0x00);
    lcm_dcs_write_seq_static(ctx, 0x00,0xF1);
    lcm_dcs_write_seq_static(ctx, 0xCE,0x15,0x15,0x15,0x01,0xC4,0x01,0xC4,0x01,0xC4);
    lcm_dcs_write_seq_static(ctx, 0x00,0xB0);
    lcm_dcs_write_seq_static(ctx, 0xCF,0x00,0x00,0x5E,0x62);
    lcm_dcs_write_seq_static(ctx, 0x00,0xB5);
    lcm_dcs_write_seq_static(ctx, 0xCF,0x03,0x03,0x4C,0x50);
    ...
    lcm_dcs_write_seq_static(ctx, 0xCF,0x06,0x06,0x3F,0x43);
    lcm_dcs_write_seq_static(ctx, 0x00,0x60);
    lcm_dcs_write_seq_static(ctx, 0xCF,0x00,0x00,0x5E,0x62,0x03,0x03,0x4C,0x50);
    lcm_dcs_write_seq_static(ctx, 0x00,0x70);
    lcm_dcs_write_seq_static(ctx, 0xCF,0x00,0x00,0x5B,0x5F,0x03,0x03,0x94,0x98);
    ...
    lcm_dcs_write_seq_static(ctx, 0xCF,0x07,0x64,0x07,0x63,0x07,0x63,0x07,0x63,0x07,0x63,0x07,0x63);
    lcm_dcs_write_seq_static(ctx, 0x00,0x80);
    ...
    lcm_dcs_write_seq_static(ctx, 0x00,0x00);
    lcm_dcs_write_seq_static(ctx, 0x1F,0x3C,0x3C);
    lcm_dcs_write_seq_static(ctx, 0x00,0x80);
    lcm_dcs_write_seq_static(ctx, 0xCC,0x26,0x00,0x26,0x00,0x17,0x03,0x01,0x00,0x00,0x00,0x0D,0x0B,0x09,0x07,0x00,0x00);
    lcm_dcs_write_seq_static(ctx, 0x00,0x90);
    lcm_dcs_write_seq_static(ctx, 0xCC,0x00,0x00,0x26,0x26,0x26,0x00,0x00,0x00);
    lcm_dcs_write_seq_static(ctx, 0x00,0x80);
    lcm_dcs_write_seq_static(ctx, 0xCD,0x26,0x00,0x26,0x00,0x16,0x02,0x01,0x00,0x00,0x00,0x0C,0x0A,0x08,0x06,0x00,0x00);
    lcm_dcs_write_seq_static(ctx, 0x00,0x90);
    lcm_dcs_write_seq_static(ctx, 0xCD,0x00,0x00,0x26,0x26,0x26,0x00,0x00,0x00);
    lcm_dcs_write_seq_static(ctx, 0x00,0xA0);
    lcm_dcs_write_seq_static(ctx, 0xCC,0x26,0x00,0x26,0x00,0x17,0x03,0x01,0x00,0x00,0x00,0x0D,0x0B,0x09,0x07,0x00,0x00);
    lcm_dcs_write_seq_static(ctx, 0x00,0xB0);
    lcm_dcs_write_seq_static(ctx, 0xCC,0x00,0x00,0x26,0x26,0x26,0x00,0x00,0x00);
    ...
    lcm_dcs_write_seq_static(ctx, 0x00,0x90);
    lcm_dcs_write_seq_static(ctx, 0xCB,0x30,0x00,0x00,0x30,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
    ...
    lcm_dcs_write_seq_static(ctx, 0xC2,0x87,0x06,0xC3,0x00);
    lcm_dcs_write_seq_static(ctx, 0x00,0x6C);
    lcm_dcs_write_seq_static(ctx, 0xC2,0x86,0x06,0xC3,0x00);
    lcm_dcs_write_seq_static(ctx, 0x00,0xEA);
    lcm_dcs_write_seq_static(ctx, 0xC2,0x12,0x00,0x07,0x08,0x00,0x00,0x00,0x00);
    lcm_dcs_write_seq_static(ctx, 0x00,0x8C);
    lcm_dcs_write_seq_static(ctx, 0xC2,0x84,0x85,0x25,0xD0,0xBA);
    lcm_dcs_write_seq_static(ctx, 0x00,0x91);
    lcm_dcs_write_seq_static(ctx, 0xC2,0x83,0x84,0x25,0xD0,0xBA);
    lcm_dcs_write_seq_static(ctx, 0x00,0x96);
    lcm_dcs_write_seq_static(ctx, 0xC2,0x82,0x83,0x25,0xD0,0xBA);
    lcm_dcs_write_seq_static(ctx, 0x00,0x9B);
    lcm_dcs_write_seq_static(ctx, 0xC2,0x81,0x82,0x25,0xD0,0xBA);
    lcm_dcs_write_seq_static(ctx, 0x00,0xA0);
    lcm_dcs_write_seq_static(ctx, 0xC2,0x80,0x81,0x25,0xD0,0xBA);
    lcm_dcs_write_seq_static(ctx, 0x00,0xA5);
    lcm_dcs_write_seq_static(ctx, 0xC2,0x01,0x80,0x25,0xD0,0xBA);
    lcm_dcs_write_seq_static(ctx, 0x00,0xAA);
    lcm_dcs_write_seq_static(ctx, 0xC2,0x02,0x01,0x25,0xD0,0xBA);
    lcm_dcs_write_seq_static(ctx, 0x00,0xAF);
    lcm_dcs_write_seq_static(ctx, 0xC2,0x03,0x02,0x25,0xD0,0xBA);
    lcm_dcs_write_seq_static(ctx, 0x00,0xDC);
    lcm_dcs_write_seq_static(ctx, 0xC2,0x77,0x77,0x77,0x77,0x00,0x00,0x00,0x00);
    lcm_dcs_write_seq_static(ctx, 0x00,0x78);
    lcm_dcs_write_seq_static(ctx, 0xC2,0x02,0x03,0x00,0x00);
    lcm_dcs_write_seq_static(ctx, 0x00,0x7C);
    lcm_dcs_write_seq_static(ctx, 0xC2,0x03,0x03,0x00,0x00);
    ...
    lcm_dcs_write_seq_static(ctx, 0xC0,0xFC,0x00,0xB1,0x00,0x1E);
    lcm_dcs_write_seq_static(ctx, 0x00,0xD1);
    lcm_dcs_write_seq_static(ctx, 0xCE,0x00,0x14,0x01,0x01,0x00,0x98,0x01);
    lcm_dcs_write_seq_static(ctx, 0x00,0xE8);
    lcm_dcs_write_seq_static(ctx, 0xCE,0x00,0x98,0x00,0x98);
    ...
    lcm_dcs_write_seq_static(ctx, 0x00,0xB0);
    lcm_dcs_write_seq_static(ctx, 0xCA,0x00,0x00,0x0C);
    lcm_dcs_write_seq_static(ctx, 0x00,0xB5);
    lcm_dcs_write_seq_static(ctx, 0xCA,0x04); // PWM 12bit 26Khz dimming 16frame
    lcm_dcs_write_seq_static(ctx, 0x00,0x00);
...
static int lcm_unprepare(struct drm_panel *panel)
{
    ...
    if (g_smart_wakeup_flag) {
        lcm_suspend_setting(ctx);//lcm_aot_suspend_setting
    } else {
        lcm_suspend_setting(ctx);//lcm_aot_suspend_setting
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
    ...
    pr_info("%s+ lcm, ft8057p_xx_ctc\n", __func__);

    if (!lcm_detect_panel("ft8057p_xx_ctc")) {
        return -ENODEV;
    }
...
static struct mipi_dsi_driver lcm_driver = {
    ...
    .remove = lcm_remove,
    .driver = {
        .name = "lcd_ft8057p_xx_ctc_mipi_hd_video",
        .owner = THIS_MODULE,
...
MODULE_DESCRIPTION("lcm ft8057p video lcd Panel Driver");
