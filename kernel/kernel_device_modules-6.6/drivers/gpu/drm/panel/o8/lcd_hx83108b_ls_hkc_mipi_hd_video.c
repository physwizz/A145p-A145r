...
static void lcm_panel_init(struct lcm *ctx)
{
    ...
    lcm_dcs_write_seq_static(ctx, 0xD9, 0xD7);
    lcm_dcs_write_seq_static(ctx, 0xE9, 0x3F);
    lcm_dcs_write_seq_static(ctx, 0xB1, 0x2C, 0x32, 0x32, 0x2F, 0x2F, 0x22, 0x43, 0x43, 0x1A, 0x1A, 0x0C, 0x98, 0x21, 0x11, 0x46, 0x43, 0x64, 0x24);
    lcm_dcs_write_seq_static(ctx, 0xB2, 0x00, 0x26, 0xD0, 0x40, 0x00, 0x26, 0xBA, 0x20, 0x98, 0x31, 0x00, 0x00, 0x00, 0x54, 0x22, 0xDF);
    lcm_dcs_write_seq_static(ctx, 0xB4, 0x5A, 0x5A, 0x5A, 0x5A, 0x5A, 0x5A, 0x75, 0x6A, 0x75, 0x6A, 0x02, 0x8D, 0x01, 0x02);
    ...
    lcm_dcs_write_seq_static(ctx, 0xD3, 0xC0, 0x00, 0x0C, 0x0C, 0x00, 0x00, 0x5B, 0x5B, 0x66, 0x6B, 0x1D, 0x1D, 0x1D, 0x1D, 0x32, 0x10, 0x19, 0x00, 0x19, 0x32, 0x10, 0x1D, 0x00, 0x1D, 0x32, 0x10, 0x19, 0x00, 0x19, 0x00, 0x00);
    ...
    lcm_dcs_write_seq_static(ctx, 0xD6, 0x18, 0x18, 0x18, 0x18, 0x3E, 0x3E, 0x3E, 0x3E, 0x18, 0x18, 0x18, 0x18, 0xBE, 0xBE, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0xBE, 0xBE, 0x01, 0x00, 0x03, 0x02, 0x05, 0x04, 0x07, 0x06, 0x09, 0x08, 0x0B, 0x0A, 0x25, 0x24, 0x23, 0x22, 0x21, 0x20, 0x18, 0x18, 0x18, 0x18);
    ...
    lcm_dcs_write_seq_static(ctx, 0xE0, 0x00, 0x04, 0x0C, 0x11, 0x18, 0x25, 0x3B, 0x41, 0x48, 0x45, 0x60, 0x67, 0x6F, 0x81, 0x81, 0x8B, 0x94, 0xA8, 0xA7, 0x52, 0x5A, 0x65, 0x73, 0x00, 0x04, 0x0C, 0x11, 0x18, 0x25, 0x3B, 0x41, 0x48, 0x45, 0x60, 0x67, 0x6F, 0x81, 0x81, 0x8B, 0x94, 0xA8, 0xA7, 0x52, 0x5A, 0x65, 0x73);
    lcm_dcs_write_seq_static(ctx, 0xE7, 0x07, 0x14, 0x14, 0x15, 0x0F, 0x84, 0x00, 0x3C, 0x3C, 0x32, 0x32, 0x00, 0x00, 0x00, 0x00, 0x98, 0x10, 0x01, 0x02);
    ...
    lcm_dcs_write_seq_static(ctx, 0xE9, 0xC6);
    lcm_dcs_write_seq_static(ctx, 0xD2, 0x18, 0x34);
    lcm_dcs_write_seq_static(ctx, 0xE9, 0x3F);
    lcm_dcs_write_seq_static(ctx, 0xD3, 0x00, 0x04, 0x00, 0x28, 0x00, 0x00, 0x00, 0x80, 0x04);
    lcm_dcs_write_seq_static(ctx, 0xD8, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
    ...
    pr_info("%s+ lcm, hx83108b_ls_hkc\n", __func__);

    if (!lcm_detect_panel("hx83108b_ls_hkc")) {
        return -ENODEV;
    }
...
static struct mipi_dsi_driver lcm_driver = {
    ...
    .remove = lcm_remove,
    .driver = {
        .name = "lcd_hx83108b_ls_hkc_mipi_hd_video",
        .owner = THIS_MODULE,
