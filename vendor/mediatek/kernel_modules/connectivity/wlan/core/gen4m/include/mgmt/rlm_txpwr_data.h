...
struct COUNTRY_POWER_LIMIT_TABLE_CONFIGURATION
	...
	,
	{	{'U', 'S'}
		, 36, {24, 24, 24, 31, 31, 31, 31, 31, 31}
	}
	,
	{	{'U', 'S'}
		, 38, {31, 31, 31, 24, 24, 31, 31, 31, 31}
	}
	,
	{	{'U', 'S'}
		, 42, {31, 31, 31, 31, 31, 25, 25, 26, 26}
	}
	,
	{	{'U', 'S'}
		, 58, {31, 31, 31, 31, 31, 25, 25, 28, 28}
	}
	,
	{	{'U', 'S'}
		, 62, {31, 31, 31, 24, 24, 31, 31, 31, 31}
	}
	,
	{	{'U', 'S'}
		, 64, {20, 20, 20, 31, 31, 31, 31, 31, 31}
	}
	,
	{	{'U', 'S'}
		, 100, {20, 20, 20, 31, 31, 31, 31, 31, 31}
	}
	,
	{	{'U', 'S'}
		, 102, {31, 31, 31, 22, 22, 31, 31, 31, 31}
	}
	,
	{	{'U', 'S'}
		, 106, {31, 31, 31, 31, 31, 25, 25, 28, 28}
	}
	,
	{	{'U', 'S'}
		, 140, {22, 22, 22, 31, 31, 31, 31, 31, 31}
	}
	,
#else
	{	{'U', 'S'}
